...
public class PantallaGanador extends VBox {
	...
	public PantallaGanador(Stage stage) throws FileNotFoundException {
        ...
        Image imagen = new Image(new FileInputStream("images/ImagenVictoria.png"));
        ...
        String musicFile = "sounds/MusicaVictoria.mp3";
